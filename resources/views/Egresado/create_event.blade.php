<div class="modal fade modal-slide-in-left" aria-hidden="true"
		role="dialog" tabindex="-1" id="modal-create-event">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h3 class="modal-title">Agregar evento academico</h3>
				</div>
				<div class="modal-body col-sm-12">
                    <div class="col-sm-6">
						...
						<div class="form-group">
							...
							<input type="text" name="event_name" class="form-control" placeholder="Nombre de la actividad">
						</div>

						<div class="form-group">
							<label for="nombre">Condición</label>
							<input type="text" name="condition" class="form-control" placeholder="Nombre de la actividad">
						</div>

						<div class="form-group">
							<label for="nombre">Descripción</label>
							<textarea name="description" rows="4" class="form-control" placeholder="Descripción de la actividad"></textarea>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
